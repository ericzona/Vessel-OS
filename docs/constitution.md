...
We, the Pioneers of The Great Transit, establish this Constitution to govern our journey through the void. This document defines the principles, economics, and rights of all participants in the Vessel-OS ecosystem.

---

## Article I: The Mission

**The Great Transit** is a multi-generational journey to establish a new civilization in a distant Galaxy. All systems, mechanics, and governance structures serve this singular purpose: *survival and arrival*.

### Section 1.1: Core Principles

1. **Transparency** - All game mechanics are documented and verifiable
2. **Fairness** - No hidden advantages; skill and strategy determine success
3. **Community** - Players are co-Pioneers, not competitors
4. **Sustainability** - Economic systems designed for long-term viability
5. **Legacy** - Early participants are honored in perpetuity

---

## Article II: The $SCRAP Economy

### Section 2.1: $SCRAP Token Definition
...
- **Transferability:** Tradeable between players (future implementation)
...
**Yield:** 1-5 $SCRAP per mining action  
...
- **Shadow Ledger:** All in-game transactions tracked for future token migration

---

## Article III: The Right of Return

### Section 3.1: Legacy Holder Protection
...
4. **Cosmetic Recognition** - Unique in-game visual markers (ship skins, badges)
...
- Time invested (total gameplay hours)

**Formula:** `Airdrop Amount = (Earned - Spent) × 1.5 + (Hours Played ÷ 10)`

This ensures early players who invested time are rewarded fairly.

---

## Article IV: Pioneer DAO Governance
...
- Determine partnerships and integrations

### Section 4.2: Voting Rights

**One Token, One Vote** - Each $SCRAP token = 1 vote  
**Weighted for Legacy** - Legacy holders receive 2x voting power  
**Quadratic Voting** - Optional: reduces whale influence  

### Section 4.3: Proposal Process

1. **Proposal Submission** - Any holder with 1000+ $SCRAP can submit
2. **Discussion Period** - 7 days for community review
3. **Voting Period** - 3 days for yes/no vote
...
### Section 5.2: Tracked Metrics

- Player ID (wallet address, future integration)
- $SCRAP mined (total accumulated)
- $SCRAP spent (total consumed)
- Repairs performed
- Ship upgrades purchased
- Items crafted
- Trades with other players (future)
- Time played (total hours)

### Section 5.3: Privacy & Security

- Shadow Ledger data encrypted at rest
- Personal identifiers (future wallet addresses) hashed
- Aggregate data published monthly for transparency
- Individual balances viewable only by player

---

## Article VI: Economic Sustainability
...
- No infinite $SCRAP exploits (audited mechanics)
...
- Transparent multi-sig wallet (future: on-chain)

---

## Article VII: Player Rights
...
- Sell or trade their $SCRAP (future: DEX integration)
...
- Account theft (security best practices enforced)
...
4. Community may fork and continue independently

**Developer Commitment:** The core team will never abandon the project without community transition.

---

## Signatories

**Founding Developer:** Eric (Hypehouse Ventures)  
**AI Architect:** Aura/CodeAgent (Fingerprint V1)  
**Date Ratified:** January 19, 2026  
**Version:** 1.0
...
- **Pioneer:** A player of The Great Transit
- **$SCRAP:** The native resource/utility token
- **Shadow Ledger:** Pre-blockchain transaction database
- **Legacy Holder:** Alpha/beta participant before token launch
- **Pioneer DAO:** Decentralized governance organization
- **The Void:** The space environment where resources are mined
- **Subjective Time:** In-game time manipulation resource
